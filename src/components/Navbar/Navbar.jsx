  ...
  return (
    <nav className="brutal-nav">
      ...
      <div className="mobile-menu-btn">
        <button className="brutal-btn" style={{ padding: '12px', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px' }} aria-label="Open menu">
